...
def Menu():
    ...
    time.sleep(0.1)
    print(bullet_gen.generate('Grab from Archives'))
    time.sleep(0.1)
    print(bullet_gen.generate('Grab from Special'))
    time.sleep(0.1)
    print(bullet_gen.generate('Grab from Onhold'))
    time.sleep(0.1)
    print(bullet_gen.generate('Grab from Notifier'))
    time.sleep(0.1)
    print(bullet_gen.generate('All (Archive, Special, Onhold)'))
    time.sleep(0.1)
